defmodule PixelgameWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-xl p-4">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-lg bg-zinc-900 p-8 shadow-lg ring-1 transition"
            >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PixelgameWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PixelgameWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  attr :player, Player, default: %Player{}
  attr :rest, :global

  def player_tile(assigns) do
    ~H"""
    <%= case @player.shape do %>
      <% :cross -> %>
        <.cross stroke={@player.color} {@rest} />
      <% :circle -> %>
        <.circle stroke={@player.color} {@rest} />
      <% :square -> %>
        <.square stroke={@player.color} {@rest} />
      <% :triangle -> %>
        <.triangle stroke={@player.color} {@rest} />
    <% end %>
    """
  end

  attr :rest, :global, include: ~w(stroke)
